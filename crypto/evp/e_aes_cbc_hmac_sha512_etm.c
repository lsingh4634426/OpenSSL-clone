...
static EVP_CIPHER hwaes_192_cbc_hmac_sha512_etm_cipher = {
# ifdef NID_aes_192_cbc_hmac_sha512_etm
...
static EVP_CIPHER hwaes_256_cbc_hmac_sha512_etm_cipher = {
# ifdef NID_aes_256_cbc_hmac_sha512_etm
...
const EVP_CIPHER *EVP_aes_128_cbc_hmac_sha512_etm(void)
{
    return (HWAES_CBC_HMAC_SHA512_CAPABLE ?
            &hwaes_128_cbc_hmac_sha512_etm_cipher : NULL);
}

const EVP_CIPHER *EVP_aes_192_cbc_hmac_sha512_etm(void)
{
    return (HWAES_CBC_HMAC_SHA512_CAPABLE ?
            &hwaes_192_cbc_hmac_sha512_etm_cipher : NULL);
}

const EVP_CIPHER *EVP_aes_256_cbc_hmac_sha512_etm(void)
{
    return (HWAES_CBC_HMAC_SHA512_CAPABLE ?
            &hwaes_256_cbc_hmac_sha512_etm_cipher : NULL);
}
#else
const EVP_CIPHER *EVP_aes_128_cbc_hmac_sha512_etm(void)
{
