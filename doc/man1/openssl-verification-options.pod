...
If the specified EKU is the special 'wildcard' EKU B<anyExtendedKeyUsage>
the check passes for any certificate.
Otherwise the target or "leaf" certificate (which may be an end-entity
certificate or CA certificate) must either not have an EKU extension,
or the EKU extension must include the specified EKU or B<anyExtendedKeyUsage>.
