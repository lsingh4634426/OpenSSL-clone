...
The certificate must either not have an EKU extension,
or the EKU extension must include the desired EKU I<nid>
or B<anyExtendedKeyUsage>, or I<nid> equals B<anyExtendedKeyUsage>.
If I<eku_included> is nonzero the EKU extension
